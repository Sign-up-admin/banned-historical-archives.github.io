...
如果您只是想使用网站查看历史档案，请参考以下文档：

If you just want to use the website to view historical archives, please refer to the following documents:

- **[API.md](API.md)** - 数据 API 说明 / Data API Documentation
- **[TROUBLESHOOTING.md](TROUBLESHOOTING.md)** - 常见问题解决 / Troubleshooting

### 🛠️ 开发者 / Developers

如果您想了解项目架构、进行二次开发或本地部署，请参考：
...
- **[local-search-engine.md](local-search-engine.md)** - 本地搜索引擎 / Local Search Engine
...
1. 在 [GitHub Issues](https://github.com/banned-historical-archives/banned-historical-archives.github.io/issues) 中报告
2. 提交 Pull Request 改进文档
3. 联系维护者

Report in [GitHub Issues](https://github.com/banned-historical-archives/banned-historical-archives.github.io/issues), submit Pull Request to improve documentation, or contact maintainers.
