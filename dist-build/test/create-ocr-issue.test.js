...
(0, vitest_1.describe)('create ocr issue', async () => {
    ...
    vitest_1.it.skip('test1 - OCR automated document entry workflow', async () => {
...
`;
        ...
        process.env.BODY = issue_body;
        process.env.TITLE = '[自动化文稿录入]test';
