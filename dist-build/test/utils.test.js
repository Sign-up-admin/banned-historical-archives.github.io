...
(0, vitest_1.describe)('apply_patch_v2', () => {
    ...
    (0, vitest_1.it)('should handle basic patch structure', () => {
        const patch = {
            version: 2,
            parts: {},
            comments: {},
        ...
        const result = (0, utils_1.apply_patch_v2)(baseParserResult, patch);
        (0, vitest_1.expect)(result).toBeDefined();
        (0, vitest_1.expect)(result.title).toBe(baseParserResult.title);
        (0, vitest_1.expect)(result.authors).toEqual(baseParserResult.authors);
        (0, vitest_1.expect)(result.description).toBe(''); // Should be empty when no description provided
    });
    (0, vitest_1.it)('should handle comment deletion', () => {
        const patch = {
            version: 2,
            parts: {},
            comments: {
        ...
        (0, vitest_1.expect)(result.comments).toBeDefined();
        (0, vitest_1.expect)(result.comments.length).toBeLessThan(baseParserResult.comments.length);
    });
    (0, vitest_1.it)('should handle new comments', () => {
        const patch = {
            version: 2,
            parts: {},
            comments: {},
    ...
    (0, vitest_1.it)('should handle part insertion', () => {
        const patch = {
            version: 2,
            parts: {
                '0': {
        ...
        (0, vitest_1.expect)(result.parts.length).toBeGreaterThan(baseParserResult.parts.length);
        (0, vitest_1.expect)(result.parts.some(part => part.text === 'inserted before')).toBe(true);
        (0, vitest_1.expect)(result.parts.some(part => part.text === 'inserted after')).toBe(true);
    });
    (0, vitest_1.it)('should handle part deletion', () => {
        const patch = {
            version: 2,
            parts: {
                '0': {
        ...
        (0, vitest_1.expect)(result.parts.length).toBeLessThan(baseParserResult.parts.length);
        // The deleted part should not be present
        (0, vitest_1.expect)(result.parts.some(part => part.text === 'mzd111jq222ywy')).toBe(false);
    });
    (0, vitest_1.it)('should handle type modification', () => {
        const patch = {
            version: 2,
            parts: {
                '0': {
        ...
        (0, vitest_1.expect)(result.parts[0].type).toBe('title');
    });
});
